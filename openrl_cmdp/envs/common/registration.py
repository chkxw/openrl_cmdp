...
import openrl
from openrl_cmdp.envs.PettingZoo.registration import pettingzoo_env_dict
from openrl_cmdp.envs.vec_env import (
    AsyncVectorEnv,
    BaseVecEnv,
    RewardWrapper,
    SyncVectorEnv,
...
from openrl_cmdp.envs.vec_env.vec_info import VecInfoFactory
from openrl_cmdp.rewards import RewardFactory
    ...
    **kwargs,
    ...
    if make_custom_envs is not None:
        ...
        if id.startswith("pybullet_drones/"):
            from openrl_cmdp.envs.gym_pybullet_drones import make_single_agent_drone_envs
            ...
            from openrl_cmdp.envs.snake import make_snake_envs
            ...
            from openrl_cmdp.envs.gymnasium import make_old_gym_envs
            ...
            from openrl_cmdp.envs.gymnasium import make_gym_envs

            env_fns = make_gym_envs(
                id=id, env_num=env_num, render_mode=convert_render_mode, **kwargs
            )
        elif id in openrl.envs.mpe_all_envs:
            from openrl_cmdp.envs.mpe import make_mpe_envs
            ...
            from openrl_cmdp.envs.nlp import make_nlp_envs
            ...
            from openrl_cmdp.envs.toy_envs import make_toy_envs
            ...
            from openrl_cmdp.envs.super_mario import make_super_mario_envs

            env_fns = make_super_mario_envs(
                id=id, env_num=env_num, render_mode=convert_render_mode, **kwargs
            )
        elif id in openrl.envs.connect_all_envs:
            from openrl_cmdp.envs.connect_env import make_connect_envs

            env_fns = make_connect_envs(
                id=id, env_num=env_num, render_mode=convert_render_mode, **kwargs
            )
        elif id in openrl.envs.gridworld_all_envs:
            from openrl_cmdp.envs.gridworld import make_gridworld_envs

            env_fns = make_gridworld_envs(
                id=id, env_num=env_num, render_mode=convert_render_mode, **kwargs
            )
        elif id in openrl.envs.offline_all_envs:
            from openrl_cmdp.envs.offline import make_offline_envs
            ...
            from openrl_cmdp.envs.crafter import make_crafter_envs

            env_fns = make_crafter_envs(
                id=id, env_num=env_num, render_mode=convert_render_mode, **kwargs
            )
        elif id in openrl.envs.pettingzoo_all_envs or id in pettingzoo_env_dict.keys():
            from openrl_cmdp.envs.PettingZoo import make_PettingZoo_envs
