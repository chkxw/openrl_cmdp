...
from openrl_cmdp.envs.vec_env.vec_info.simple_vec_info import SimpleVecInfo
...
class VecInfoFactory:
    ...
    def auto_register(vec_info_class: Any):
        if vec_info_class is None:
            ...
            from openrl_cmdp.envs.vec_env.vec_info.nlp_vec_info import NLPVecInfo

            VecInfoFactory.register("NLPVecInfo", NLPVecInfo)
        elif vec_info_class.id == "EPS_RewardInfo":
            from openrl_cmdp.envs.vec_env.vec_info.episode_rewards_info import EPS_RewardInfo
