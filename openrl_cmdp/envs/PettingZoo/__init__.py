...
from openrl_cmdp.envs.common import build_envs
from openrl_cmdp.envs.PettingZoo.registration import pettingzoo_env_dict, register
from openrl_cmdp.envs.wrappers.pettingzoo_wrappers import CheckAgentNumber, SeedEnv


def PettingZoo_make(id, render_mode, disable_env_checker, **kwargs):
    kwargs.__setitem__("id", id)
    if id.startswith("snakes_"):
        from openrl_cmdp.envs.snake.snake_pettingzoo import SnakeEatBeansAECEnv
...
def make_PettingZoo_envs(
    ...
    **kwargs,
    ...
    from openrl_cmdp.envs.wrappers import (  # AutoReset,; DictWrapper,; Single2MultiAgentWrapper,
