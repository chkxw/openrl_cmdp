...
from openrl_cmdp import __AUTHOR__, __EMAIL__, __TITLE__, __VERSION__
from openrl_cmdp.utils.util import get_system_info
...
def run(mode: str, env: str, env_step: int):
    if mode == "train":
        from openrl_cmdp.cli.train import train_agent
