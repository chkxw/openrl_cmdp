...
from openrl_cmdp.selfplay.callbacks.base_callback import BaseSelfplayCallback
from openrl_cmdp.selfplay.opponents.opponent_template import OpponentTemplate
