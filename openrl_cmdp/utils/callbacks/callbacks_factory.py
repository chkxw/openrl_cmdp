...
from openrl_cmdp.selfplay.callbacks.selfplay_callback import SelfplayCallback
from openrl_cmdp.utils.callbacks.callbacks import BaseCallback, CallbackList, EveryNTimesteps
from openrl_cmdp.utils.callbacks.checkpoint_callback import CheckpointCallback
from openrl_cmdp.utils.callbacks.eval_callback import EvalCallback
from openrl_cmdp.utils.callbacks.processbar_callback import ProgressBarCallback
from openrl_cmdp.utils.callbacks.stop_callback import (
...
class CallbackFactory:
    ...
    def get_callback(
        ...
        if callback["id"] == "SelfplayAPI" and "SelfplayAPI" not in callbacks_dict:
            from openrl_cmdp.selfplay.callbacks.selfplay_api import SelfplayAPI
