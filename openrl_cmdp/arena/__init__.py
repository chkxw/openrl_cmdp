...
import openrl
from openrl_cmdp.arena.two_player_arena import TwoPlayerArena
from openrl_cmdp.envs import pettingzoo_all_envs
...
def make_arena(
    ...
    **kwargs,
    ...
    if custom_build_env is None:
        from openrl_cmdp.envs import PettingZoo

        if (
            env_id in pettingzoo_all_envs
            or env_id in PettingZoo.registration.pettingzoo_env_dict.keys()
        ):
            from openrl_cmdp.envs.PettingZoo import make_PettingZoo_env
